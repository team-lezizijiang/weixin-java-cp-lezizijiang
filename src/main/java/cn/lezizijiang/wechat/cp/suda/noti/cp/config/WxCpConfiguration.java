package cn.lezizijiang.wechat.cp.suda.noti.cp.config;

import cn.lezizijiang.wechat.cp.suda.noti.cp.handler.*;
...
@EnableJpaRepositories("cn.lezizijiang.wechat.cp.suda.noti.cp.repository")
